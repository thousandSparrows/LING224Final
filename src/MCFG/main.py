...
# print(
#     grammar.MCFGRuleElement('VPwhemb', (0,), (1,)),
#     "->", 
#     grammar.MCFGRuleElement('NPwh', (0,)), 
#     grammar.MCFGRuleElement('Vpres', (1,))
# )

# rule = grammar.MCFGRule.from_string('A(w1u, x1v) -> B(w1, x1) C(u, v)')
# print(rule)

# print(rule.instantiate_left_side(
#     grammar.MCFGRuleElementInstance("B", (1, 2), (5, 7)),
#     grammar.MCFGRuleElementInstance("C", (2, 4), (7, 8))
# ))
...
print(test_grammar.parts_of_speech())

# testing for finding terminal nodes
print(test_grammar.parts_of_speech('a'))

print(test_grammar.rules())

# test for finding rules
print(test_grammar.rules("NP"))

# test for reducing
A = grammar.MCFGRuleElementInstance('D', (1, 2))
B = grammar.MCFGRuleElementInstance('Nrc', (2, 3), (3, 5))
print(test_grammar.reduce(A, B))

# Test for recognizing sentences
print(test_grammar(['a', 'human', 'believes', 'a', 'human']))